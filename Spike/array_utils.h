...
extern void free_2D_iarray(int ** array2D, int nrows, int ncols);
extern int *** get_3D_iarray(int nlays, int nrows, int ncols, int init);
extern void free_3D_iarray(int *** array3D, int nlays, int nrows, int ncols);
extern float ** get_2D_farray(int nrows, int ncols, float init);
extern void free_2D_farray(float ** array2D, int nrows, int ncols);
extern float *** get_3D_farray(int nlays, int nrows, int ncols, float init);
extern void free_3D_farray(float *** array3D, int nlays, int nrows, int ncols);
