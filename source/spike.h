...
extern void printStimuli(STIMULI * stim, PARAMS * mp, const char * prefix);
extern int genShuffles(STIMULI * stim, PARAMS * mp);
extern void printSchedule(STIMULI * stim, const char * filename);
extern void calcInput(PARAMS * mp, int loop, int pat, int trans, STIMULI * stim, float ** input, int regime, const char * stimFile);
